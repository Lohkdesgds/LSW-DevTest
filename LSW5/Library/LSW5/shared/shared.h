...
namespace LSW {
	namespace v5 {
		namespace Shared {
			...
			// this have to be global
			enum class my_events { CUSTOM_EVENT_CALL_FULLSCREEN = 512, CUSTOM_EVENT_PRINTSCREEN, CUSTOM_EVENT_DISPLAY_UPDATE_RESOLUTION_SCALE, CUSTOM_EVENT_DISPLAY_CHROMA_FX /* <-- TO BE DONE */ };
