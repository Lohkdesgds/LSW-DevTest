...
namespace LSW {
	namespace v5 {
		namespace Tools {
			...
			/// <para>———————————————————————————————————————————————————————</para>
			/// <para># NOTES:</para>
			/// <para>1. Internally this is a SuperMap of a std::function that returns a type T. It has a shared_ptr of that. You can get back and set a new SuperMap of function as you please.</para>
